...
namespace APITruck.Tests.Controllers
{
    public class CrudeControllerTests
    {
        ...
        {
            _caminhaoController = new CaminhaoController(new Mock<IClienteRepository>().Object);
        }


        public List<Cliente> CriarRepository()
        {
            List<Cliente> caminhoes = new List<Cliente>() { new Cliente
            {
                Id = 1,
                AnoFabricacao = 2022,
                AnoModelo = 2023,
        ...
        {
            var resp = await _caminhaoController.GetClientes();
        ...
        {
            var resp = await _caminhaoController.Insert(new Cliente
            {
                Id = 0,
                AnoFabricacao = 2022,
                AnoModelo = 2023,
        ...
        {
            await Assert.ThrowsAsync<Exception>(async () =>
            await _caminhaoController.Insert(new Cliente
            {
                Id = 0,
                AnoFabricacao = 2022,
                AnoModelo = 2024,
        ...
        {
            await Assert.ThrowsAsync<Exception>(async () =>
            await _caminhaoController.Atualizar(0, new Cliente
            {
                Id = 0,
                AnoFabricacao = 2022,
                AnoModelo = 2023,
